...
class SaveBiometricAuthConfigurationController {
  /**
   * Constructor.
  ...
  /**
   * Save the encrypted biometric auth configuration.
   * @param {object} data The encrypted biometric auth configuration.
   * @returns {Promise<void>}
   */
  exec(data) {
    return this.biometricAuthService.saveConfiguration(data);
  }
}

export default SaveBiometricAuthConfigurationController;
